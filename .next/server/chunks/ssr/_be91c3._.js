...
;
;
const ImageSlider = ({ images = [], interval = 50000 })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const updateRadius = ()=>{
            if (sliderRef.current) {
                ...
                sliderRef.current.style.setProperty('--br-radius', `${height * 0.5}px`);
            }
        };
        updateRadius();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$data$2e$json__$28$json$29$__ = __turbopack_import__("[project]/src/data/data.json (json)");
'use client';
;
;
;
...
//# sourceMappingURL=_be91c3._.js.map